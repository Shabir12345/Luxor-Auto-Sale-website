                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-start group">
                        ...
                        <div>
                          ...
                          <a href="tel:+14165235375" className="text-green-400 hover:text-green-300 transition-colors duration-300 text-lg font-medium">
                            (416) 523-5375
                          </a>
                        </div>
                      </div>
          ...
          <div className="border-t border-gray-700/50 py-8">
            ...
            <p>&copy; {new Date().getFullYear()} Luxor Auto Sale. All rights reserved.</p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <a href="https://www.facebook.com/marketplace/profile/100073355434479/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300 group" aria-label="Follow us on Facebook">
